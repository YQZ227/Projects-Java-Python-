...
public class A4Application {
	...
	public static void main(String[] args) throws Exception {
		...
		//<classroom, occupancy> 
		KTable<String, Long> classroom_occupancy = student_classroom.groupBy((studentId, roomId) ->  new KeyValue<>(roomId, studentId)).count();
		...
		KTable<String, String> finalOutput = current_classroom.toStream().groupByKey().aggregate(() -> null, (key, newValue, oldValue) -> {
