...
echo 'Client Usage: java Client FE_host FE_port #Threads #Requests #pwdPerReq'
echo	 Examples:
echo taskset -c 0,1 $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" FENode 10798'
echo taskset -c 2,3 $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" BENode localhost 10798 10799'
echo taskset -c 4,5 $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" BENode localhost 10798 10780'
echo $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" Client localhost 10798 1 1 16'
